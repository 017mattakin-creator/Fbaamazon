...
export default function Testimonials() {
  ...
  const allTestimonials = [
    { name: { en: "Sarah Jenkins", zh: "莎拉·詹金斯" }, role: { en: "Founder, New York", zh: "创始人, 纽约" }, img: "https://live.staticflickr.com/65535/55204634305_5577da7be4_z.jpg", text: { en: "Working with this team was a game-changer for my brand. Their SFB method is incredibly effective.", zh: "与这个团队合作对我的品牌来说是一个转折点。他们的SFB方法非常有效。" } },
    ...
    { name: { en: "Elena Rodriguez", zh: "埃琳娜·罗德里格斯" }, role: { en: "Freelancer, Madrid", zh: "自由职业者, 马德里" }, img: "https://live.staticflickr.com/65535/55204486379_e8261bff90_w.jpg", text: { en: "The communication throughout the process was outstanding. They kept me updated.", zh: "整个过程中的沟通非常出色。他们一直让我了解最新情况。" } },
    { name: { en: "David Chen", zh: "大卫·陈" }, role: { en: "E-commerce Mgr, Singapore", zh: "电商经理, 新加坡" }, img: "https://live.staticflickr.com/65535/55204486389_3f7224ecbf.jpg", text: { en: "Their 180-day protection guarantee gave me the peace of mind I needed.", zh: "他们180天的保护保证让我感到安心。" } },
    { name: { en: "Sophie Dubois", zh: "索菲·杜波依斯" }, role: { en: "Boutique Owner, Paris", zh: "精品店主, 巴黎" }, img: "https://live.staticflickr.com/65535/55203341682_83726f60f2.jpg", text: { en: "I needed a safe way to launch my new product line, and this team delivered perfectly.", zh: "我需要一种安全的方式来推出我的新产品线，这个团队完美地完成了任务。" } },
    { name: { en: "James Wilson", zh: "詹姆斯·威尔逊" }, role: { en: "Consultant, Sydney", zh: "顾问, 悉尼" }, img: "https://live.staticflickr.com/65535/55204634315_b767b2ba4c.jpg", text: { en: "The FBA offer they provided was exactly what I needed to manage my inventory.", zh: "他们提供的FBA报价正是我管理库存所需要的。" } },
    { name: { en: "Amara Okafor", zh: "阿马拉·奥卡福" }, role: { en: "Artisan, Lagos", zh: "工匠, 拉各斯" }, img: "https://live.staticflickr.com/65535/55204486394_5a5fedc6ab.jpg", text: { en: "I was struggling to get my first few reviews, and this service helped me gain social proof.", zh: "我很难获得最初的几条评论，这项服务帮助我获得了社会证明。" } },
    { name: { en: "Liam O'Connor", zh: "利亚姆·奥康纳" }, role: { en: "Entrepreneur, Dublin", zh: "企业家, 都柏林" }, img: "https://live.staticflickr.com/65535/55204240406_1770925cb4.jpg", text: { en: "Reliable, honest, and effective. If you're an Amazon seller looking to boost visibility safely, look no further.", zh: "可靠、诚实且有效。如果您是一位希望安全提升曝光率的亚马逊卖家，这里就是您的不二之选。" } },
    { name: { en: "Yuki Tanaka", zh: "田中由纪" }, role: { en: "Seller, Tokyo", zh: "卖家, 东京" }, img: "https://live.staticflickr.com/65535/55204634335_7db962e9c3.jpg", text: { en: "The attention to detail in their buyer account inspection is impressive.", zh: "他们对买家账户检查的关注细节令人印象深刻。" } },
